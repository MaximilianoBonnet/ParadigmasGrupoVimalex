...
import BaseDelJuego.Juego;

public class JuegoStarWars extends Juego {
	...
	private String getEnC() {
		...
		String color = "estrellaDeLaMuerte.png";
		switch (num) {
		case 1:
			color="estrellaDeLaMuerte.png";
			break;
		case 2:
			color="HalconMilenario.png";
			break;
		case 3:
			color="TieFighter.png";
			break;
		case 0:
			color="tieIntersector.png";
			break;
		}
		return color;
	}
	...
	public static void setVelocitat(int velocitat) {
		JuegoStarWars.velocitat = velocitat;
	}
